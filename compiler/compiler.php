...
function main($request)
{
	...
	// TODO: make it compatible with non-default hardware (variants & cores)
	/// personal notes (Finnbar, prefixed with ///)
	/// create_objects goes through each set of files and creates an array of objects...
	/// IT'S NOT A CONSTRUCTOR OR ANYTHING, IT'S JUST A FUNCTION...
	$core_objects = create_objects("$ROOT/hardware/arduino/cores/$core", $ARDUINO_SKEL, false, $mcu, $f_cpu, $core, $variant, $vid, $pid);
